<!-- src/components/services/ServicesJumbotron.vue -->
<template>
    <main class="jumbotron">
        <article class="container col-md-6">
            <h1 class="title">Maximize Your Business<br>Tech Potential.</h1>
            <hr class="line">
            <p class="text">We provide a range of services—including 
...
<script>
import image1 from '@/assets/images/icons/button_arrow_black.png';
import image2 from '@/assets/images/icons/button_arrow_white.png';

export default {
    name: 'ServicesJumbotron',
    data() {
        return {
            blackImg: image1,
            whiteImg: image2
...
.jumbotron {
    height: 18rem;
    background-image: url('@/assets/images/services/services_jumbotron.png');
